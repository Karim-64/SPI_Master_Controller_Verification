    ...
    class apb_monitor extends uvm_monitor ;
        ...
        task run_phase(uvm_phase phase);
            ...
            forever begin
                ...
                rsp_seq_item.PREADY_expected        = vif_cfg.PREADY_expected;
                rsp_seq_item.PSLVERR_expected       = vif_cfg.PSLVERR_expected;
                rsp_seq_item.cfg_en_expected        = vif_cfg.cfg_en_expected;
                rsp_seq_item.cfg_mstr_expected      = vif_cfg.cfg_mstr_expected;
                rsp_seq_item.cfg_lsb_first_expected = vif_cfg.cfg_lsb_first_expected;
                rsp_seq_item.cfg_loopback_expected  = vif_cfg.cfg_loopback_expected;
                rsp_seq_item.tx_empty_expected      = vif_cfg.tx_empty_expected;
                rsp_seq_item.IRQ_expected           = vif_cfg.IRQ_expected;
                rsp_seq_item.cfg_mode_expected      = vif_cfg.cfg_mode_expected;
                rsp_seq_item.cfg_width_expected     = vif_cfg.cfg_width_expected;
                rsp_seq_item.SS_n_expected          = vif_cfg.SS_n_expected;
                rsp_seq_item.cfg_delay_expected     = vif_cfg.cfg_delay_expected;
                rsp_seq_item.cfg_clk_div_expected   = vif_cfg.cfg_clk_div_expected;
                rsp_seq_item.tx_word_expected       = vif_cfg.tx_word_expected;
                rsp_seq_item.PRDATA_expected        = vif_cfg.PRDATA_expected;
